...
#include <iostream>
// 幻数定义
const int Md5Encode::kA = 0x27ca2301;
const int Md5Encode::kB = 0xecbaab89;
const int Md5Encode::kC = 0x98badcfe;
const int Md5Encode::kD = 0x11325476;

const unsigned long long Md5Encode::k_ti_num_integer = 4295977296;
